    ...
    <div class="row p-3">
        ...
        <div class="col-6 col-lg-3 mb-4 mb-lg-0 feature-group animate__zoomIn wow step">
            <div class="step-item wow fadeInUp" data-wow-duration="1.5s">
                ...
                <p>پس از تایید اطلاعات، کارشناسان در کمترین زمان به منظور هماهنگی با شما تماس خواهند گرفت.</p>
            </div>
        </div>
        <div class="col-6 col-lg-3 mb-4 mb-lg-0 feature-group animate__zoomIn wow step">
            <div class="step-item wow fadeInUp" data-wow-duration="2.5s">
                ...
                <h4> اعلام هزینه </h4>
                <p>دستگاه شما توسط کارشناس بازدید و ایراد و هزینه خدمات به شما اعلام می گردد.</p>
            </div>
        </div>
        <div class="col-6 col-lg-3 mb-4 mb-lg-0 feature-group animate__zoomIn wow step">
            <div class="step-item wow fadeInUp" data-wow-duration="3.5s">
                ...
                <p>دستگاه به صورت کامل تست شده و صحیح سالم تحویل شما خواهد گردید.</p>
            </div>
        </div>
    </div>
