...
function mytheme_create_default_education_posts() {
    // بررسی اینکه پست خاصی قبلاً ساخته نشده
    if (null == get_page_by_title('آموزش تستی اول', OBJECT, 'education')) {
        wp_insert_post(array(
            'post_title'   => 'آموزش تستی اول',
            'post_content' => 'این یک محتوای پیش‌فرض برای آموزش اول است.',
            'post_status'  => 'publish',
            'post_type'    => 'education',
        ));
    }

    if (null == get_page_by_title('آموزش تستی دوم', OBJECT, 'education')) {
        wp_insert_post(array(
            'post_title'   => 'آموزش تستی دوم',
            'post_content' => 'این یک محتوای دیگر برای آموزش دوم است.',
            'post_status'  => 'publish',
            'post_type'    => 'education',
        ));
    }
    if (null == get_page_by_title('آموزش تستی سوم', OBJECT, 'education')) {
        wp_insert_post(array(
            'post_title'   => 'آموزش تستی سوم',
            'post_content' => 'این یک محتوای دیگر برای آموزش سوم است.',
            'post_status'  => 'publish',
            'post_type'    => 'education',
        ));
    }
    if (null == get_page_by_title('آموزش تستی چهارم', OBJECT, 'education')) {
        wp_insert_post(array(
            'post_title'   => 'آموزش تستی چهارم',
            'post_content' => 'این یک محتوای دیگر برای آموزش چهارم است.',
            'post_status'  => 'publish',
            'post_type'    => 'education',
        ));
    }
    if (null == get_page_by_title('آموزش تستی پنجم', OBJECT, 'education')) {
        wp_insert_post(array(
            'post_title'   => 'آموزش تستی پنجم',
            'post_content' => 'این یک محتوای دیگر برای آموزش پنجم است.',
            'post_status'  => 'publish',
            'post_type'    => 'education',
        ));
    }
    if (null == get_page_by_title('آموزش تستی ششم', OBJECT, 'education')) {
        wp_insert_post(array(
            'post_title'   => 'آموزش تستی ششم',
            'post_content' => 'این یک محتوای دیگر برای آموزش ششم است.',
            'post_status'  => 'publish',
            'post_type'    => 'education',
        ));
    }
    if (null == get_page_by_title('آموزش تستی هفتم', OBJECT, 'education')) {
        wp_insert_post(array(
            'post_title'   => 'آموزش تستی هفتم',
            'post_content' => 'این یک محتوای دیگر برای آموزش هفتم است.',
            'post_status'  => 'publish',
            'post_type'    => 'education',
        ));
    }
    if (null == get_page_by_title('آموزش تستی هشتم', OBJECT, 'education')) {
        wp_insert_post(array(
            'post_title'   => 'آموزش تستی هشتم',
            'post_content' => 'این یک محتوای دیگر برای آموزش هشتم است.',
            'post_status'  => 'publish',
            'post_type'    => 'education',
        ));
    }
    if (null == get_page_by_title('آموزش تستی نهم', OBJECT, 'education')) {
        wp_insert_post(array(
            'post_title'   => 'آموزش تستی نهم',
            'post_content' => 'این یک محتوای دیگر برای آموزش نهم است.',
            'post_status'  => 'publish',
            'post_type'    => 'education',
        ));
    }
    if (null == get_page_by_title('آموزش تستی دهم', OBJECT, 'education')) {
        wp_insert_post(array(
            'post_title'   => 'آموزش تستی دهم',
            'post_content' => 'این یک محتوای دیگر برای آموزش دهم است.',
            'post_status'  => 'publish',
            'post_type'    => 'education',
        ));
    }
    if (null == get_page_by_title('آموزش تستی یازدهم', OBJECT, 'education')) {
        wp_insert_post(array(
            'post_title'   => 'آموزش تستی یازدهم',
            'post_content' => 'این یک محتوای دیگر برای آموزش یازدهم است.',
            'post_status'  => 'publish',
            'post_type'    => 'education',
        ));
    }
    if (null == get_page_by_title('آموزش تستی دوازدهم', OBJECT, 'education')) {
        wp_insert_post(array(
            'post_title'   => 'آموزش تستی دوازدهم',
            'post_content' => 'این یک محتوای دیگر برای آموزش دوازدهم است.',
            'post_status'  => 'publish',
            'post_type'    => 'education',
        ));
    }
    if (null == get_page_by_title('آموزش تستی سیزدهم', OBJECT, 'education')) {
        wp_insert_post(array(
            'post_title'   => 'آموزش تستی سیزدهم',
            'post_content' => 'این یک محتوای دیگر برای آموزش سیزدهم است.',
            'post_status'  => 'publish',
            'post_type'    => 'education',
        ));
    }
    if (null == get_page_by_title(' سرویس اول', OBJECT, 'service')) {
        wp_insert_post(array(
            'post_title'   => 'سرویس اول',
            'post_content' => 'این یک محتوای دیگر برای سرویس اول است.',
            'post_status'  => 'publish',
            'post_type'    => 'service',
        ));
    }
    if (null == get_page_by_title(' سرویس دوم', OBJECT, 'service')) {
        wp_insert_post(array(
            'post_title'   => 'سرویس دوم',
            'post_content' => 'این یک محتوای دیگر برای سرویس دوم است.',
            'post_status'  => 'publish',
            'post_type'    => 'service',
        ));
    }
    if (null == get_page_by_title(' سرویس سوم', OBJECT, 'service')) {
        wp_insert_post(array(
            'post_title'   => 'سرویس سوم',
            'post_content' => 'این یک محتوای دیگر برای سرویس سوم است.',
            'post_status'  => 'publish',
            'post_type'    => 'service',
        ));
    }
    if (null == get_page_by_title(' سرویس چهارم', OBJECT, 'service')) {
        wp_insert_post(array(
            'post_title'   => 'سرویس چهارم',
            'post_content' => 'این یک محتوای دیگر برای سرویس چهارم است.',
            'post_status'  => 'publish',
            'post_type'    => 'service',
        ));
    }
    if (null == get_page_by_title(' سرویس پنجم', OBJECT, 'service')) {
        wp_insert_post(array(
            'post_title'   => 'سرویس پنجم',
            'post_content' => 'این یک محتوای دیگر برای سرویس پنجم است.',
            'post_status'  => 'publish',
            'post_type'    => 'service',
        ));
    }
}
add_action('after_switch_theme', 'mytheme_create_default_education_posts');